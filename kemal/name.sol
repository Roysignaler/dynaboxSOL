...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() ERC721("DynaboxNFT", "DYNABOX") {
        console.log("Let's fight to death!");
    }

    //name and surname at random
    ...
    //surname at random
  /*  function pickRandomSurname(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function makeAnEpiccccccNFS() public {
        ...
        string memory combinedWord = string(
            abi.encodePacked(name, first, second, third)
        );
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '",',
                        '"description": "A highly acclaimed collection of fighters.",',
